...
class CompressOp(_ods_ir.OpView):
  ...
  @builtins.property
  def filled(self) -> _ods_ir.Value:
    return self.operation.operands[1]

  @builtins.property
  def added(self) -> _ods_ir.Value:
...
class DisassembleOp(_ods_ir.OpView):
  ...
  @builtins.property
  def out_values(self) -> _ods_ir.Value:
    _ods_variadic_group_length = len(self.operation.operands) - 3 + 1
  ...
  @builtins.property
  def ret_values(self) -> _ods_ir.OpResult:
...
class ExpandOp(_ods_ir.OpView):
  ...
  @builtins.property
  def filled(self) -> _ods_ir.OpResult:
    return self.operation.results[1]

  @builtins.property
  def added(self) -> _ods_ir.OpResult:
...
class PushBackOp(_ods_ir.OpView):
  ...
  @builtins.property
  def curSize(self) -> _ods_ir.Value:
    return self.operation.operands[0]
  ...
  @builtins.property
  def n(self) -> _Optional[_ods_ir.Value]:
  ...
  @builtins.property
  def outBuffer(self) -> _ods_ir.OpResult:
    return self.operation.results[0]

  @builtins.property
  def newSize(self) -> _ods_ir.OpResult:
    return self.operation.results[1]
...
class ReorderCOOOp(_ods_ir.OpView):
  ...
  @builtins.property
  def input_coo(self) -> _ods_ir.Value:
    return self.operation.operands[0]
  ...
  @builtins.property
  def result_coo(self) -> _ods_ir.OpResult:
    return self.operation.results[0]
...
class ToSliceStrideOp(_ods_ir.OpView):
  ...
  @builtins.property
  def stride(self) -> _ods_ir.OpResult:
    return self.operation.results[0]
